  ...
  return {
    ...
    view: () => {
      ...
      return [
        ...
        m(
          "p",
          "Find a nearby climate station. The 'best' station may not be the nearest, e.g., King City North is further from us than is the Toronto airport, but the elevation is more comparable. Select a station on the map to retrieve the data for that station.",
        ),
        m("p", [
